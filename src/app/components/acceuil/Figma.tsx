...
export default function Figma() {
    return (
        ...
        <div className="mt-[550px] ml-20 rounded-[20px] border border-white/10 p-6 w-[85%] h-[245px]" >
            <div className="flex items-center space-x-4">
                ...
                />
                <span className="text-white font-bold text-lg" style={{ fontFamily: "var(--font-inter)" }}>Figma Design</span>
            </div>
            <div className="mt-3 ml-2 text-gray-300 text-base w-[90%] leading-7" style={{ fontFamily: "var(--font-inter)" }}>
