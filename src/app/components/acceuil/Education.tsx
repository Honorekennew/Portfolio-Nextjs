export default function Education() {
  return (
    <div className="w-[95%] h-[420px] border border-white/5 rounded-[20px] p-5 flex flex-col justify-between overflow-hidden">
      <div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="mt-9">
            <span className="text-gray-300 text-sm font-medium break-words" style={{ fontFamily: "var(--font-inter)" }}>HETIC</span>
            <div className="flex justify-between w-[300px] text-gray-400 text-xs">
              <span className="break-words" style={{ fontFamily: "var(--font-inter)" }}>Master CTO et Tech Lead</span>
        ...
        <div className="flex items-center space-x-4 mt-[-10px]">
          ...
          <div className="mt-9">
            <span className="text-gray-300 text-sm font-medium break-words" style={{ fontFamily: "var(--font-inter)" }}>INSTA</span>
            <div className="flex justify-between w-[300px] text-gray-400 text-xs">
              <span className="w-[50%] break-words" style={{ fontFamily: "var(--font-inter)" }}>
        ...
        <div className="flex items-center space-x-4 mt-[-10px]">
          ...
          <div className="mt-9">
            <span className="text-gray-300 text-sm font-medium break-words" style={{ fontFamily: "var(--font-inter)" }}>IUC</span>
            <div className="flex justify-between w-[300px] text-gray-400 text-xs">
              <span className="w-[50%] break-words" style={{ fontFamily: "var(--font-inter)" }}>DEC Programmation et Application Mobile</span>
